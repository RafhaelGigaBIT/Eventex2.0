...
var Fullcalendar = function() {
    var e, t, i = $('[data-toggle="calendar"]');
    i.length && (t = {
        header: {
            right: "",
            center: "",
    ...
    }, (e = i).fullCalendar(t), $("body").on("click", ".new-event--add", function() {
        ...
        var t = $(this).data("calendar"),
            i = $(".edit-event--id").val(),
            a = $(".edit-event--title").val(),
            n = $(".edit-event--description").val(),
            l = $("#edit-event .event-tag input:checked").val(),
            s = e.fullCalendar("clientEvents", i);
        "update" === t && ("" != a ? (s[0].title = a, s[0].description = n, s[0].className = [l], console.log(l), e.fullCalendar("updateEvent", s[0]), $("#edit-event").modal("hide")) : ($(".edit-event--title").closest(".form-group").addClass("has-error"), $(".edit-event--title").focus())), "delete" === t && ($("#edit-event").modal("hide"), setTimeout(function() {
            swal({
                title: "Are you sure?",
                ...
                t.value && (e.fullCalendar("removeEvents", i), swal({
                    title: "Deleted!",
        ...
        var i = $(this).attr("data-calendar-view");
        e.fullCalendar("changeView", i)
